...
sample_questions = df[df['Difficulty'].isna()].sample(sample_size, random_state=442)
...
# Vectorize the questions using TF-IDF with a max feature limit to reduce overfitting
...
# Train an SVM classifier with a linear kernel and balanced class weights
